...
(function (URLType) {
    ...
    URLType[URLType["ihuan"] = 2] = "ihuan";
})(URLType || (URLType = {}));
class HomeController {
    constructor(ipCount = 100, action = undefined, urlType = URLType["66ip"]) {
        /**
         * 抓取代理IP
    ...
    async get66ipData(ipCount = 100, urlType = URLType["66ip"]) {
        try {
                ...
                case URLType["89ip"]:
                    options = {
                        ...
                        headers: {
                            ...
                            referer: referer,
                            Cookie: '__cfduid=d9d801abc67718d98c4886083838f8b2d1592553636; cf_chl_1=6ea3a775ea35da0; statistics=6aa22f8afb172793f3803c076764d327; Hm_lvt_8ccd0ef22095c2eebfe4cd6187dea829=1592553640,1593485279,1593485316,1593500741; Hm_lpvt_8ccd0ef22095c2eebfe4cd6187dea829=1593501292',
                            Host: Host
                        }
                    };
                    break;
            ...
            // 发出http请求
            let data = await rp(options, (err, rep, data) => { if (err != undefined) {
                console.log(err);
            } });
    ...
    async init(ipCount = 100, action = undefined, urlType = URLType["66ip"]) {
